...
export const run: RouteRun = async (app, req: UpdateRequest, res) => {
    ...
    if (req.body.name) data.name = req.body.name; else data.name = currentData.name;
    if (req.body.live) data.live = req.body.live; else data.live = currentData.live;
    if (req.body.link) data.link = req.body.link; else data.link = currentData.link;
    if (req.body.description) data.description = req.body.description; else data.description = currentData.description;
